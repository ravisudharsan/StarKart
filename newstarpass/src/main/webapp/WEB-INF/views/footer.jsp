...
<li><a href="contactus"><i class="fa fa-envelope fa-fw"></i> Contact Us</a></li>
   ...
   <div class="col-sm-6 col-md-2">
	...
	<div id="recent-posts-3" class="widget widgetFooter widget_recent_entries">
     ...
     <a href="https://www.facebook.com" target="_blank"><i class="facebook"></i> Facebook</a>
					</li>

					<li>
				      
<a href="https://www.twitter.com" target="_blank"><i class="twitter"></i> Twitter</a>
					
</li>
					
<li>
				   
   <a href="http://www.youtube.com" target="_blank"><i class="youtube"></i> Youtube</a>
...
<h4 class="widgettitle">Search in Google :</h4>
           ...
           <a href="https://www.google.com" button class="btn btn-primary" type="button">Search !</button></a>
