			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img
									src="https://img3.nbstatic.in/la-l/56ae32a40b04512cde6c1e95.jpg" /></a></li>
					...
					<div class="details col-md-6">
						...
						<H3>What you get</H3>
						<br> Day Outing with Snacks and Games valid for 1 person(s)<br>
						<h3>Validity</h3>
						Day Outing with Snacks and Games<br> Valid from:17-May-2016<br>
						Valid until:30-Nov-2016<br> Valid on : All Days<br>
