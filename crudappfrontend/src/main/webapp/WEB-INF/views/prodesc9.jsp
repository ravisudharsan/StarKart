			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img
									src="http://paulsons.in/img/slider-new-2/tg-2.jpg" /></a></li>
					...
					<div class="details col-md-6">
						...
						<H3>What you get</H3>
						<br> Stylist Womens haircut & threading valid for 1 person(s)<br>
						<h3>Validity</h3>
						Stylist Womens haircut & threading<br> Valid from:29-Apr-2016<br>
						Valid until:31-Jan-2017<br> Valid on : Monday to Thursday<br>
						Valid on : Monday to Thursday<br> Valid on : Monday to
						Thursday<br> Valid on : Monday to Thursday<br>
