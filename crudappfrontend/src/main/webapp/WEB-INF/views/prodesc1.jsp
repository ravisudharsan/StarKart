					...
					<div class="preview col-md-6">
						...
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img
									src="http://cache.marriott.com/propertyimages/m/maacy/phototour/maacy_phototour14.jpg?Log=1" /></a></li>

						</ul>

					</div>
					<div class="details col-md-6">
						<h3 class="product-title">The Courtyard Marriot</h3>
						<div class="rating">
							<div class="stars">
						...
						<H3>What you get</H3>
						<br> <br> Buffet lUNCH valid for 1 person(s)<br>
						<h3>Validity</h3>
