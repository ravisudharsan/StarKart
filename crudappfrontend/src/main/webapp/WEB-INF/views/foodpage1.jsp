	...
	<div id="wrap">
		<div id="columns" class="columns_3">
			<figure>
				...
				<a class="button" href="prodesc">Book Now</a>
			</figure>
			...
			<figure>
				...
				<a class="button" href="prodesc1">Book Now</a>
			</figure>
			...
			<figure>
				...
				<a class="button" href="prodesc2">Book Now</a>
			</figure>
			...
			<figure>
				...
				<a class="button" href="prodesc3">Book Now</a>
			</figure>

			<figure>
				<img
					src="http://lifeandtrendz.com/wp-content/uploads/2016/02/CCD-New-Logo.jpg"
					width="697" height="395">
				<figcaption>Cafe Coffee Day</figcaption>
				<span class="price">45Rs</span>
				<a class="button" href="prodesc4">Book Now</a>
			</figure>

			<figure>
				<img
					src="http://2.bp.blogspot.com/-gPN8gvTRIHk/VqXtVD-Av3I/AAAAAAAAFNM/kLZmA4Tb9tY/s1600/decorated-barbeque-nation-rajajinagar-bangalore-bappi-lahiri-launch-disco-king-shiju-sugunan-craniumbolts-food-review.jpg"
					width="697" height="395">
				<figcaption>Barebeque Nation</figcaption>
				<span class="price">650Rs</span>
				<a class="button" href="prodesc6">Book Now</a>
			</figure>
			...
			<figure>
				...
				<a class="button" href="prodesc8">Book Now</a>
			</figure>

			<figure>
				<img
					src="C:\Users\Rudy\workspace\soos\src\main\resources\image\bg.jpg"
					width="697" height="395">
				<figcaption>Burger King</figcaption>
				<span class="price">129Rs</span>
				<a class="button" href="prodesc9">Book Now</a>
			</figure>
