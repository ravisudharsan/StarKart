			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img
									src="https://media-cdn.tripadvisor.com/media/photo-s/07/89/0b/7a/hablis.jpg" /></a></li>
					...
					<div class="details col-md-6">
						...
						<h3>Validity</h3>
						Buffet Breakfast<br> Valid from:04-May-2016<br> Valid
						until:14-Feb-2017<br> Timings: 7:00 A.M to 10:00 A.M<br>
						Valid on: All Days<br> Valid for dine-in. Not valid for
						takeaway / home delivery | Blackout dates: 24th, 25th, 31st
						Dec,Jan 1st & Feb 14th |
