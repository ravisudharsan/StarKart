...
<nav class="navbar navbar-default" style="background-color: #491066;">
	...
	<ul class="nav navbar-nav">
		...
		<li><a href="offerzone"><font color="#f7f7ff">Offer
					Zone</font></a></li>
	</ul>
	<ul class="nav navbar-nav navbar-right">
		<c:if test="${not empty SuccessMessage }">
			...
			<li><a href="home"><span class="glyphicon glyphicon-log-out"></span><font
					color="#f7f7ff"> Logout</font></a></li>
		</c:if>
		<c:if test="${ empty SuccessMessage }">
			<li><a href="register"><span
					class="glyphicon glyphicon-user"></span> <font color="#f7f7ff">Signup</font></a></li>
			<li><a href="login"><span class="glyphicon glyphicon-log-in"></span>
					<font color="#f7f7ff">Login</font></a></li>
		</c:if>
	</ul>
	<div class="container">
		<div class="row">
