			...
			<table align:center>
				<tr>
					...
					<td><label for="First Namesignup" class="Fname" data-icon="F">First
							Name</label></td>
					<td>:</td>
					<td><input id="First Namesignup" name="First Namesignup"
						required="required" type="text" placeholder="mysuperFirstname" /></td>
				</tr>
				<tr>
					<td><label for="Last Namesignup" class="Lname" data-icon="L">Last
							Name</label>
					<td>:</td>
					<td><input id="Last Namesignup" name="Last Namesignup"
						required="required" type="text" placeholder="mysuperLastname" />
				</tr>
				...
				<tr>
					...
					<td>:</td>
					<td><input id="DOBsignup" name="DOBsignup" required="required"
						type="text" placeholder="dd - mm - yy" /></td>
				</tr>
				...
				<tr>
					...
					<td><label for="usernamesignup" class="uname" data-icon="u">Your
							username</label></td>
					<td>:</td>
					<td><input id="usernamesignup" name="usernamesignup"
						required="required" type="text" placeholder="mysuperusername690" /></td>
				</tr>
				...
				<tr>
					...
					<td><input id="passwordsignup" name="passwordsignup"
						required="required" type="password" placeholder="eg. X8df!90EO" /></td>
				</tr>
