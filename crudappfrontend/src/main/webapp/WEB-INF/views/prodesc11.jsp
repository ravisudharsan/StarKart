			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img
									src="https://img2.nbstatic.in/la-l/56b00b2d0b04512cde6e1ecd.jpg" /></a></li>
					...
					<div class="details col-md-6">
						...
						<H3>What you get</H3>
						<br> Men: Haircut + Sun-tan Facial + Shave valid for 1
						person(s)<br>
						<h3>Validity</h3>
						Men: Haircut + Sun-tan Facial + Shave<br> Valid
						from:26-Apr-2016<br> Valid until:10-Feb-2017<br> Timings
						: 10:00 A.M to 7:00 P.M<br> Valid on : All Days<br>
