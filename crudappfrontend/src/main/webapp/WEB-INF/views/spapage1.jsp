	...
	<div class="col-md-5 column productbox">
		...
		<div class="productprice">
			<div class="pull-right">
				<a href="prodesc9" class="btn btn-danger btn-sm" role="button">BUY</a>
			</div>
			<div class="pricetext">3999Rs</div>
		</div>
	</div>
	<div class="col-md-5 column productbox">
		<img
		...
		<div class="productprice">
			<div class="pull-right">
				<a href="prodesc10" class="btn btn-danger btn-sm" role="button">BUY</a>
			</div>
			<div class="pricetext">1099Rs</div>
		</div>
	</div>
	<div class="col-md-5 column productbox">
		<img src="https://img2.nbstatic.in/la-l/56b00b2d0b04512cde6e1ecd.jpg"
			class="img-responsive">
		<div class="producttitle">Zique Saloon</div>
		<div class="productprice">
			<div class="pull-right">
				<a href="prodesc11" class="btn btn-danger btn-sm" role="button">BUY</a>
			</div>
